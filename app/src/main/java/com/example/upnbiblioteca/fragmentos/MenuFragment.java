...
public class MenuFragment extends Fragment {
    private final int[] BOTONES ={R.id.frgMenBtnInicio, R.id.frgMenBtnBuscar, R.id.frgMenBtnEstante,
            R.id.frgMenBtnListas, R.id.frgMenBtnMas};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i=0;i<BOTONES.length;++i){
            imageButton = view.findViewById(BOTONES[i]);
